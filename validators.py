# =====================================================================
# validators.py — فاليديشن مدخلات الـ APIs
#
# نتحقق من المدخلات في الباك اند حتى لو الفرونت يفلتر، عشان:
# 1) الحماية من Postman / curl / scripts خارجية
# 2) الحماية لو فيه bug في الفرونت
# 3) Defense in Depth — مبدأ الدفاع المتعدد الطبقات
# =====================================================================

# الحقول الرقمية المطلوبة + الحد الأدنى لكل وحد (مطابق للفرونت)
