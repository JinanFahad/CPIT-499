...
export default function MyProjectsPageNew() {
  ...
  const userName =
    localStorage.getItem("userName") || (isAr ? "المستخدم" : "User");
  ...
  useEffect(() => {
    // Try Firebase first; fall back to localStorage in case Firebase
    // hasn't finished hydrating yet on this page load.
    const userId =
