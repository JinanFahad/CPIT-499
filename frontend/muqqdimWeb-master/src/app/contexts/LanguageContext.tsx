...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    "dashboard.subtitle":
      "منصة ذكاء اصطناعي لإنشاء دراسات الجدوى ومساعد الإجراءات الحكومية",
    ...
    "dashboard.feasibilityDesc":
      "إنشاء دراسات جدوى شاملة ومفصلة باستخدام الذكاء الاصطناعي",
    "dashboard.governmentGuide": "دليل الإجراءات الحكومية",
    "dashboard.governmentDesc":
      "مساعدة ذكية في إنجاز الإجراءات الحكومية والتراخيص",
    "dashboard.consultantTitle": "مستشار ذكي",
    "dashboard.consultantDesc":
      "استشارات فورية حول مشروعك من خبير ذكاء اصطناعي",
    ...
    "feasibility.subtitle":
      "املأ النموذج أدناه لإنشاء دراسة جدوى شاملة لمشروعك",
    ...
    "feasibility.descriptionPlaceholder":
      "مثال: مقهى عصري يقدم القهوة المختصة والمعجنات الطازجة مع أجواء مريحة للعمل والدراسة...",
    "feasibility.targetMarket": "السوق المستهدف",
    "feasibility.targetMarketPlaceholder":
      "مثال: العائلات والشباب في الأحياء الراقية",
    ...
    "feasibility.competitorsPlaceholder":
      "مثال: ستاربكس، كوستا كافيه، مقاهي محلية",
    ...
    "feasibility.autoSaveNote":
      'سيتم حفظ مشروعك تلقائياً ويمكنك الوصول إليه من صفحة "مشاريعي"',
    ...
    "projects.noProjectsDesc":
      "ابدأ بإنشاء مشروعك الأول وأعد دراسة جدوى احترافية بسهولة",
    ...
    "projects.generatingFeasibility":
      "سيقوم الذكاء الاصطناعي بتوليد دراستك وتحميلها",
    "projects.generatingPitchDeck":
  ...
  en: {
    ...
    "dashboard.subtitle":
      "AI-powered platform for creating feasibility studies and government procedures assistant",
    ...
    "dashboard.servicesSubtitle":
      "Integrated solutions to help you build your successful project",
    "dashboard.feasibilityStudy": "Feasibility Study",
    "dashboard.feasibilityDesc":
      "Create comprehensive and detailed feasibility studies using AI",
    "dashboard.governmentGuide": "Government Procedures Guide",
    "dashboard.governmentDesc":
      "Smart assistance in completing government procedures and licenses",
    "dashboard.consultantTitle": "Smart Consultant",
    "dashboard.consultantDesc":
      "Instant consultations about your project from an AI expert",
    "dashboard.faqTitle": "Frequently Asked Questions",
    "dashboard.faqSubtitle":
      "Answers to the most important questions about the platform",

    // Feasibility Study Page
    "feasibility.title": "Create New Feasibility Study",
    "feasibility.subtitle":
      "Fill out the form below to create a comprehensive feasibility study for your project",
    ...
    "feasibility.descriptionPlaceholder":
      "Example: A modern café serving specialty coffee and fresh pastries with a comfortable atmosphere for work and study...",
    "feasibility.targetMarket": "Target Market",
    "feasibility.targetMarketPlaceholder":
      "Example: Families and youth in upscale neighborhoods",
    "feasibility.timeline": "Expected Timeline",
    "feasibility.timelinePlaceholder": "Example: 4-6 months",
    "feasibility.team": "Required Team",
    "feasibility.teamPlaceholder":
      "Example: 8-12 employees (chefs, baristas, service)",
    "feasibility.competitors": "Potential Competitors",
    "feasibility.competitorsPlaceholder":
      "Example: Starbucks, Costa Coffee, local cafés",
    ...
    "feasibility.autoSaveNote":
      'Your project will be saved automatically and you can access it from the "My Projects" page',

    // My Projects Page
    "projects.title": "My Projects",
    "projects.subtitle": "All feasibility studies you have created",
    "projects.welcome": "Welcome",
    "projects.welcomeDesc":
      "Here you can access all your projects and feasibility studies",
    ...
    "projects.noProjectsDesc":
      "Start by creating your first project and easily prepare a professional feasibility study",
    ...
    "projects.generatingFeasibility":
      "AI will generate your study and download it",
    "projects.generatingPitchDeck":
      "AI will create your pitch deck and download it",
    ...
    "government.subtitle":
      "Your smart guide to complete all government procedures",
