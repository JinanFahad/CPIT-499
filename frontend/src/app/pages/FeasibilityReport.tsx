...
export default function FeasibilityReport() {
  ...
  // ── Early returns ─────────────────────────────────────────────────
  // While loading or translating, show the shared branded loading dialog
  // on top of the (otherwise blank) page chrome.
    ...
    return (
      <>
        ...
        <LoadingModal
          ...
          description={
            translating
              ? (isAr ? "جاري ترجمة الدراسة" : "Translating the report")
              : (isAr ? "جاري تحميل الدراسة" : "Loading the report")
          }
          dir={isAr ? "rtl" : "ltr"}
        />
      </>
