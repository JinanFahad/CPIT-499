      ...
      >
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="w-full max-w-md bg-white/80 dark:bg-[#08312D]/40 backdrop-blur-md rounded-2xl p-8 border border-[#C6A75E]/30 card-glow">
            ...
            {error && (
              <div
                className={`mb-4 p-3 bg-red-100 border border-red-400 text-red-700 rounded-xl text-sm ${isAr ? "text-right" : "text-left"}`}
              >
                {error}
              </div>
            )}
          ...
          <div className="relative z-10 text-center px-12">
            <div className="mb-8">
              <img
                ...
                alt="MOQDDIM"
                className="dark:hidden h-72 w-auto mx-auto drop-shadow-2xl"
              />
              <img
                src={logoImage}
                alt="MOQDDIM"
                className="hidden dark:block h-72 w-auto mx-auto drop-shadow-2xl"
              />
            </div>
            ...
            <p
              className={`text-[#08312D] dark:text-white/90 text-lg max-w-md mx-auto leading-relaxed ${isAr ? "font-[Changa]" : ""}`}
              style={
                !isAr
                ...
                <div className="px-7 py-7">
                  ...
                  {forgotStatus ? (
                    ...
                    >
                      ...
                      <p
                        className={`text-sm leading-relaxed ${forgotStatus.type === "success" ? "text-[#08312D]" : "text-red-800"}`}
                      >
                        {forgotStatus.msg}
                      </p>
                    </div>
