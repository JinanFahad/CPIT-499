...
const inputClass =
  "w-full bg-gray-50 dark:bg-gray-100 border border-gray-300 dark:border-gray-400 text-[#08312d] dark:text-gray-900 placeholder:text-gray-400 rounded-lg px-4 py-3 text-base font-medium font-[Changa] focus:ring-2 focus:ring-[#C6A75E] focus:border-[#C6A75E] focus:outline-none";
const selectClass =
...
export default function EditProjectPage() {
  ...
  useEffect(() => {
    ...
    fetch(`${BACKEND_URL}/api/projects/${projectId}`)
      ...
      .then((project) => {
        if (project.id) {
          const mainProductsArr = Array.isArray(project.main_products)
      ...
      const projectResponse = await fetch(
        `${BACKEND_URL}/api/projects/${projectId}`,
        {
          ...
          body: JSON.stringify({
            ...
            project_type:
              businessTypeMap[formData.businessType] || "restaurant",
            restaurant_type: formData.restaurantType,
            city: cityMap[formData.city] || formData.city,
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-600 text-sm font-[Changa] mt-1">
                  {isAr
                    ? "عدّل بيانات مشروعك وسيتم إعادة توليد الدراسة تلقائياً"
                    : "Edit your project data and the study will be regenerated"}
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t-2 border-gray-200 dark:border-gray-300">
              ...
              <Link
                ...
                className="h-14 bg-gray-50 dark:bg-gray-100 border border-gray-300 rounded-lg px-6 text-gray-700 hover:bg-gray-100 transition-all flex items-center justify-center font-semibold font-[Changa] text-sm"
              >
                {isAr ? "إلغاء" : "Cancel"}
              </Link>
            </div>
